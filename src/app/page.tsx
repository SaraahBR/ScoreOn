  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 6 }}>
      ...
      <Typography variant="body1" sx={{ mb: 4 }}>
        {t("landing.subtitle", { defaultValue: "Gerencie turmas, cadastre alunos e registre avaliações com praticidade." })}
      </Typography>

      <Stack direction="row" spacing={2} sx={{ mb: 6 }}>
        <Button variant="contained" component={Link} href="/login/criar-conta">
          {t("landing.cta_start", { defaultValue: "Começar agora" })}
        </Button>
        <Button variant="outlined" component={Link} href="/documentacao">
